              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $row2["name"];?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Nom D'utilisateur</div>
                    <div class="col-lg-9 col-md-8"><?php echo $row2["username"];?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Service</div>
                    <div class="col-lg-9 col-md-8"><?php echo $row2["service"];?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Numéro De Bureau</div>
                    <div class="col-lg-9 col-md-8"><?php echo $row2["numBureau"];?></div>
                  </div>
                    <?php }  $conn->close(); ?>
