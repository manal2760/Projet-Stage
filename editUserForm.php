            ...
            <div class="card-body">
              ...
              <form method="post" action="editUser.php">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="matricule" value="<?php echo $row['id'];?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nomComplet" value="<?php echo $row['name'];?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Nom D'utilisateur</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nomUtilisateur" value="<?php echo $row['username'];?>">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="numBureau" value="<?php echo $row['numBureau'];?>">
                  </div>
                </div>
                  <?php }  $conn->close(); ?>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button  type="submit" name="modifier" class="btn btn-primary" style="text-align":center>Modifier</button>
                  </div>
                </div>
