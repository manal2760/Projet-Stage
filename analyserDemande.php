...
//  { $idUser = $_SESSION['id'];}
 ...
 {
 $id = $_GET['id'];
 $query = "SELECT * FROM demandes WHERE idDemande=$id;";
          ...
          <div class="card">
            <div class="card-body">
              <?php while($row = $result->fetch_assoc())
                  {?>
              <h5 class="card-title">Demande d'intervention Numéro <?php echo $row['idDemande'];?>  </h5>
              ...
              <form method="post" action="">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="matricule" value="<?php echo $row['idUser'];?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nomComplet" value="<?php echo $row['nomComplet'];?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Date d'ajout</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="date" value="<?php echo $row['date'];?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Système D'information</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="mdp" value="<?php echo $row['SI'];?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Autre</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Type d'intervention</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Autre Type </label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="autreType" value="<?php echo $row['autreType'];?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10" id="myBtns">
                    <a  href="dashboard.php" name="precedant" class="btn btn-primary" id="btn1" >Précédant</a>
                   <?php echo '  <a  href="terminerDemande.php?id2=' . $row['idDemande'] . '" name="precedant" class="btn btn-primary" id="btn2" >Marquer Comme Terminée</a>'; ?>
