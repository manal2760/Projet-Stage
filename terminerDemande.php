    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Marquer Comme Terminée </h5>

              <!-- General Form Elements -->
            <?php  while($row = $result->fetch_assoc())
              {  ?>
              <form method="post" action="addIntervention.php">
                <div class="row mb-3">
                  <!-- <label for="inputText" class="col-sm-2 col-form-label">Matricule</label> -->
                  <div class="col-sm-10">
                    <input type="hidden" class="form-control" name="idDemande" value="<?php echo $row['idDemande'];?>" >
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Matricule</label>
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Intervenant</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name="statut" required>
                       <option class="option" value="en attente">En attente</option>
                       <option class="option" value="terminée">Terminée</option>
                ...
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Observation</label>
                  <div class="col-sm-10">
                        <textarea class="form-control" style="height: 100px" name="observation"></textarea>
                  </div>
                </div>
